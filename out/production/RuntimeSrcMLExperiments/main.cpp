...
treenode * root; /* stores syntax tree for later return */
...
{
       0,    57,    57,    60,    65,    68,    69,    72,    77,    84,
      87,    93,   101,   104,   109,   114,   119,   123,   130,   137,
     141,   144,   148,   151,   154,   157,   160,   163,   168,   171,
     174,   179,   187,   194,   197,   203,   208,   213,   216,   222,
     228,   233,   236,   239,   242,   245,   248,   253,   258,   263,
     263,   266,   271,   276,   276,   279,   282,   286,   289,   294,
     299,   302,   305,   310
};
#endif
...
#line 60 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval) = new treenode(21,"declaration_list");
...
#line 72 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval) = new treenode(40, "var_declaration");
...
#line 77 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval) = new treenode(41, "var_declaration");
...
#line 87 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval) = new treenode(51, "type_specifier");
(yyval)->type = "void";
}
...
#line 93 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval)= new treenode(60, (yyvsp[-4])->name);
...
#line 109 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval)= new treenode(80, "param_list");
(yyval)->children.push_back((yyvsp[-2]));
(yyval)->children.push_back((yyvsp[0]));
}
...
#line 119 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval)= new treenode(90, (yyvsp[0])->name);
...
#line 130 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval)= new treenode(100, "compound_statement");
(yyval)->children.push_back((yyvsp[-2]));
(yyval)->children.push_back((yyvsp[-1]));
}
...
#line 141 "../CMinus.y" /* yacc.c:1646  */
    {(yyval)= new treenode(111, "local_declarations");}
...
#line 148 "../CMinus.y" /* yacc.c:1646  */
    {(yyval)= new treenode(121, "expression list");}
...
#line 179 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval)= new treenode(151, "if..else");
...
#line 213 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval)= new treenode(190, (yyvsp[0])->name);
}
...
#line 216 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval)= new treenode(191, (yyvsp[-3])->name);
(yyval)->children.push_back((yyvsp[-1]));
}
...
#line 253 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval)= new treenode(220, (yyvsp[-1])->name);
(yyval)->children.push_back((yyvsp[-2]));
(yyval)->children.push_back((yyvsp[0]));
}
...
#line 266 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval)= new treenode(240, (yyvsp[-1])->name);
(yyval)->children.push_back((yyvsp[-2]));
(yyval)->children.push_back((yyvsp[0]));
}
...
#line 282 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval) = new treenode(261, (yyvsp[0])->name);
...
#line 286 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval)=(yyvsp[0]); (yyval)->ruleNum = 262;
}
...
#line 289 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval) = new treenode(263, (yyvsp[0])->name);
}
...
#line 305 "../CMinus.y" /* yacc.c:1646  */
    {
(yyval)= new treenode(291, "arg_list");
(yyval)->children.push_back((yyvsp[-2]));
(yyval)->children.push_back((yyvsp[0]));
}
